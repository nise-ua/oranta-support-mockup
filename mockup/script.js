  ...
  ua: {
    ...
    thankYou: {
      ...
      paragraphs: [
        ...
        "Дякуємо, що ви з нами.<br>Дякуємо за вашу довіру.<br>Дякуємо, що ви частина нашої місії.<br>Разом ми можемо допомагати там, де це найбільше потрібно."
      ],
      signoff: "З вдячністю,<br>Команда Oranta"
    },
    donation: {
      title: "Варіанти пожертв",
      intro: "Ми вдячні за кожен внесок і прагнемо зробити процес пожертв якомога зручнішим. Наразі Oranta приймає пожертви кількома способами:",
      methods: [
        "Zelle: <a href=\"mailto:Oranta.UA.USA@gmail.com\">Oranta.UA.USA@gmail.com</a>",
        "<a href=\"https://www.paypal.com/ncp/payment/AL9WVEHG4SNW2\" target=\"_blank\" rel=\"noopener noreferrer\">PayPal donate secure link</a>",
    ...
    campaigns: [
      ...
      ["Фармакологія та загальна медицина", "Передаємо ліки, медичні засоби та підтримку цивільним, які інакше могли б залишитися без необхідного лікування й допомоги."],
      ["Порятунок і догляд за тваринами", "Допомагаємо тваринам, які постраждали від війни та переміщення, забезпечуючи їх їжею, ветеринарною допомогою, перевезенням і прихистком."]
    ],
    support: "Підтримати",
    footer: {
      ...
      difference: "Зробімо зміни разом",
      differenceText: "Ваша підтримка допомагає нам дістатися до людей і тварин, які найбільше потребують допомоги.",
